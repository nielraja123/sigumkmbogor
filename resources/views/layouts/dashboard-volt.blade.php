            ...
            <ul class="nav flex-column pt-3 pt-md-0">
                ...
                <li class="nav-item">
                    <a href="/" class="nav-link d-flex align-items-center">
                        ...
                        <span class="mt-1 ms-1 sidebar-text">SIG UMKM Kota Bogor</span>
                    </a>
                </li>
                ...
                <li class="nav-item">
                    ...
                    <div class="multi-level collapse " role="list" id="submenu-app" aria-expanded="false">
                        <ul class="flex-column nav">
                            <li class="nav-item {{ Request::is('choropleth') ? 'active' : '' }}">
                                <a href="{{ route('choropleth') }}" class="nav-link ">
                                    <span class="sidebar-icon ">
                                        <i class="fas fa-map-marked-alt"></i>
                                    </span>
                                    <span class="sidebar-text">Choropleth</span>
                                </a>
                            </li>                   
                            <li class="nav-item ">
                                ...
                                <span class="sidebar-text">Kelola UMKM</span>
                              </a>
                            </li>
                            {{--  --}}
                            <li class="nav-item">
